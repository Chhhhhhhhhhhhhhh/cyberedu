...
[English](README.md) | [更新日志](versions/CHANGELOG.md)
...
- 🌐 **英文全文翻译**：52 个章节完整翻译 + UI 中英文切换
- 📝 **内容质量审查**：4 位审查 agent 修复 22 处事实性错误
- 🎨 **排版优化**：间距增大 15-30%，侧边栏收起时内容自动填充宽度
- 🐛 修复：语言切换后章节不刷新、英文正文不显示、模板字面量转义错误
